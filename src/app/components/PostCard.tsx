  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ aspectRatio: "4/3", background: "#F5EAE0" }}
      >
        {post.photos[0] ? (
          <ImageWithFallback
            src={post.photos[0]}
        ...
        >
          ...
          <span style={{ fontSize: 12, fontWeight: 600, color: "#1C0E0A" }}>
            {avg.toFixed(1)}
          </span>
        </div>
        {/* Photo count */}
      ...
      <div className="p-4">
        ...
        <p className="text-xs font-medium mb-2" style={{ color: "#C1415A" }}>
          {post.shopName}
        </p>

        <div
          className="flex items-center gap-1 mb-3"
          style={{ color: "#8B6558", fontSize: 12 }}
        >
          <MapPin size={12} />
          <span>
